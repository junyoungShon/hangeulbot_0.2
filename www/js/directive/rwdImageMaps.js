        ...
        element.bind('load', function() {
          ...
          function resize(){
            ...
            var wPercent = $(element).width()/100,
              ...
              c = 'coords';
            console.log('맵이름'+map+"넓이 퍼센테이지"+wPercent+"//높이 퍼센테이지"+hPercent);

            $('map[name="' + map + '"]').find('area').each(function(){

              console.log('area를 찾아서 반복문을 돌아 이 문장이 두번나와야 정상');
              ...
              console.log('새로운 coordsPercent'+coordsPercent.toString());
